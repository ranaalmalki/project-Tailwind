...
function About() {
  return (
    <div>
        ...
        <div className=" p-40 col-span-9  backgroundimg-about bg-white">
...
<div className="card-actions justify-end">
        ...
        <div className="backgroundvideo h-96 w-96">
            <h1>Dianna Adam's Family </h1>
            <p>Est, cras aliquet nunc, habitant velit ac, et sit tincidunt amet mi nulla pellentesque dignissim mattis tempor. </p>
        </div>
        </div>
        <div className=" grid grid-flow-row justify-center p-20 bg-[#f1eeed]">
        <div className="flex justify-between">

            <h1 className="text-4xl pb-5 font-bold">Follow along</h1>
            <button className="btn text-[#be7d69] bg-white hover:bg-[#be7d69] hover:text-white col-span-1">@DIANNAADAMS</button>
</div>
            <br/>
