...
<div className="w-full grid grid-flow-col change-hight -z-10 size-full ">
        <div className="bg-[#f5f5f5] p-40 col-span-9 ">
        ...
        <div className="flex flex-row-reverse">
            <img className="col-span-2" loading="lazy" decoding="async" width="150" height="100" src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-featured-in-logo-5.svg"  alt=""/>
            <img
        ...
        <div className="bg-[#be7d69] p-40 col-span-4 ">
